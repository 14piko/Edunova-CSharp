...
namespace UcenjeCS.LjetniRad
{
    internal class Helpers
    {
        ...
        public static string OibInput(string? stara, string poruka)
        {
            while (true)
            {
                Console.ForegroundColor = ConsoleColor.Cyan;
                ...
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("OIB ne može biti prazan!");
                    Console.ForegroundColor = ConsoleColor.White;
                    continue;
                }

                if (oib.Length != 11 || !long.TryParse(oib, out _))
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                ...
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("OIB nije valjan!");
                    Console.ForegroundColor = ConsoleColor.White;
                    continue;
                }
        ...
        private static bool IsValidOib(string oib)
        {
            if (oib.Length != 11 || !long.TryParse(oib, out _))
            {
                return false;
